...
function App() {
  ...
  useEffect(() => {
    fetch('http://localhost:82/tipificacion')//apuntador//pedniendte para la explicacion backend en springboot
...
<Card>
  ...
  <div class="col">
    ...
    <div class="col">
    <label for="validationCustom01" class="form-label">Buscar Nombre SimulaciÃ³n</label>
...
<Card className="text-center">
      ...
      <h5 class="card-title">{item.nombre_SIMULACION}</h5>
...
{[
        ...
        >
          ...
          <Card.Body>
            ...
            <Card.Text>
            <Card.Title>NÃºmero SimulaciÃ³n</Card.Title>
            <Card.Title>{item.codigo_SIMULACION} </Card.Title>
            </Card.Text>
          </Card.Body>
        </Card>
      ))}
   ...
   {[
        ...
        >
          ...
          <Card.Body>
            ...
            <Card.Text>
            <Card.Title>C0digo Nivel Superior</Card.Title>
            <Card.Title>{item.codigo_NIVEL_SUPERIOR}</Card.Title>
            </Card.Text>
          </Card.Body>
        </Card>
      ))}
...
{[
        ...
        >
          ...
          <Card.Body>
            ...
            <Card.Text>
            <Card.Title>Cargo de Nivel Superior</Card.Title>
            <Card.Title>:{item.cargo_NIVEL_SUPERIOR}</Card.Title>
            </Card.Text>
          </Card.Body>
        </Card>
      ))}
   ...
   {[
        ...
        >
          ...
          <Card.Body>
            ...
            <Card.Title>{item.nombre_JEFE}</Card.Title>
            </Card.Text>
          </Card.Body>
        </Card>
      ))}
     ...
     {item.fecha}
      ...
      <Card>
        <Card.Body>
          <Card.Title>Fecha de Inicio de SimulaciÃ³n</Card.Title>
          <Card.Text>
          {item.fecha_INICIO_SIMULACION}
          </Card.Text>
        </Card.Body>
        <Card.Footer>
        </Card.Footer>
      ...
      <Card>
        ...
        <Card.Body>
          <Card.Title>Fecha de Fin de SimulaciÃ³n</Card.Title>
          <Card.Text>
          
          {item.fecha_FIN_SIMULACION}
          </Card.Text>
        </Card.Body>
        <Card.Footer>
        </Card.Footer>
